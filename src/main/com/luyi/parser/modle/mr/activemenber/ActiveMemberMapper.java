...
public class ActiveMemberMapper extends Mapper<LongWritable,Text,StatsUserDimension,TimeOutputWritable> {
    ...
    private KpiDimension ActiveBorwserMemberKpi = new KpiDimension(KpiTypeEnum.BROWSER_ACTIVE_MEMBER.kpiName);
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        statsCommonDimension.setKpiDimension(ActiveBorwserMemberKpi);
        this.k.setStatsCommonDimension(statsCommonDimension);
        context.write(this.k,this.v);
